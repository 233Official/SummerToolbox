...
const ImageConverter = () => {
  ...
  const [sizeOption, setSizeOption] = useState<"predefined" | "custom">(
    "predefined"
  );
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        // 确定尺寸
        const width =
          sizeOption === "predefined" ? parseInt(selectedSize) : customWidth;
        const height =
          sizeOption === "predefined" ? parseInt(selectedSize) : customHeight;
              ...
              <>
                <Box mb="md" style={{ textAlign: "center" }}>
                  ...
                  <Box
                    style={{
                      background:
                        "repeating-conic-gradient(#f5f5f5 0% 25%, transparent 0% 50%) 0% 0% / 20px 20px",
                      padding: "20px",
                      borderRadius: "4px",
                    }}
                  >
